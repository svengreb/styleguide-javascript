...
module.exports = {
  ...
  rules: {
     ...
     * Allows `arrays` and `objects` only if it is explicitly noted what `array` and `object` contains, using `arrayOf`, `objectOf`, or `shape`.
     ...
     * @see https://github.com/svengreb/styleguide-javascript/blob/main/rules/react/naming_conventions.md#one-component-per-file
     */
     ...
     * @see https://github.com/svengreb/styleguide-javascript/blob/main/rules/react/props.md#ref-callbacks
     */
     ...
     * @see https://github.com/svengreb/styleguide-javascript/blob/main/rules/react/classes_and_constructors.md#class-and-stateless
     */
     ...
     * @see https://github.com/svengreb/styleguide-javascript/blob/main/rules/react/methods.md#render-return
     */
    "react/require-render-return": "error",
    /**
     * Prevent extra closing tags for components without children.
     * @see https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/self-closing-comp.md
     * @see https://github.com/svengreb/styleguide-javascript/blob/main/rules/react/tags.md#self-closing
     */
